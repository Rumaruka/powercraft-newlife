...
public class PCLightValue {

    public static final double THz = 1e12;
    private double[] frequencyAndIntensity;

    public PCLightValue(double...frequencyAndIntensity){
    ...
    public PCVec3 toColor(){
        PCVec3 color = new PCVec3();
    ...
    private static PCVec3 getColorForFrequencyAndIntensity(double frequency, double intensity){
        double red;
        double green;
        double blue;
        double factor;
        ...
        PCVec3 color = new PCVec3(adjust(red, factor), adjust(green, factor), adjust(blue, factor));
        return color.mul(intensity);
    }

    public PCLightValue filterBy(PCLightFilter filter){
        if(filter==null)
            return this;
