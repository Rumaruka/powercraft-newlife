...
public class PCPacketTileEntityMessageIntCTS extends PCPacketServerToClient {
    private int x;
    private int y;
    private int z;
    ...
    public PCPacketTileEntityMessageIntCTS(){

    }

    public PCPacketTileEntityMessageIntCTS(PCTileEntityAPI te, NBTTagCompound nbtTagCompound, long session){
