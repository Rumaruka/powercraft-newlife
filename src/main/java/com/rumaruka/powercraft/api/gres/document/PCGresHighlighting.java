...
public class PCGresHighlighting {
    ...
    public void addBlockHighlight(IMultiplePossibilities start, IMultiplePossibilities escape, IMultiplePossibilities end, boolean isMultiline, String formatting, PCGresHighlighting highlighting){
    ...
    public static class BlockHighlight extends Highlight{
        ...
        private final PCGresHighlighting highlighting;
        ...
        public BlockHighlight(IMultiplePossibilities start, IMultiplePossibilities escape, IMultiplePossibilities end, boolean isMultiline, String formatting, PCGresHighlighting highlighting) {
            super(start, formatting);
            this.escape = escape;
            this.end = end;
            this.isMultiline = isMultiline;
        ...
        public PCGresHighlighting getHighlighting() {
